<?php
  ...
  $JobRequest_sql = "INSERT INTO  job
    (JobID, DateLogged, UserID, RoomID, AssetID, Broken_Mouse, Broken_Keyboard, Broken_Screen, ExtraInfo, JobStatusID, PartsUsed, DateComplete) VALUES (NULL, CURRENT_TIMESTAMP, :UserID, :Room, NULL, :Broken_Mouse,  :Broken_Keyboard, :Broken_Screen, :ExtraInfo, 1, NULL, NULL);";
